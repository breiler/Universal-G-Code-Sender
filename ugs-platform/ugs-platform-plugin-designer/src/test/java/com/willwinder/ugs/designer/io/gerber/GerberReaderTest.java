...
public class GerberReaderTest {
    ...
    public void readCenterLine() {
        ...
        String data = """
                ...
                X1000000Y1000000D01*
                """;
        com.willwinder.ugs.designer.io.gerber.GerberReader reader = new com.willwinder.ugs.designer.io.gerber.GerberReader();
    ...
    public void readCircleAsDrillHole() {
        String data = """
                ...
                X5080000Y3810000D03*
                """;
        com.willwinder.ugs.designer.io.gerber.GerberReader reader = new com.willwinder.ugs.designer.io.gerber.GerberReader(true);
        Design design = reader.read(IOUtils.toInputStream(data, StandardCharsets.UTF_8)).orElseThrow();
        assertEquals(1, design.getEntities().size());
