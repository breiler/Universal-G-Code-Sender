...
public class RotateActionTest {
    ...
    public void testAbsoluteRotation() {
        ...
        com.willwinder.ugs.designer.actions.RotateAction action = com.willwinder.ugs.designer.actions.RotateAction.rotateTo(group, 45.0);
        action.redo();
    ...
    public void testRotationOver360() {
        ...
        com.willwinder.ugs.designer.actions.RotateAction action = com.willwinder.ugs.designer.actions.RotateAction.rotateTo(group, 405.0);
        action.redo();
    ...
    public void testUndo() {
        ...
        com.willwinder.ugs.designer.actions.RotateAction action = com.willwinder.ugs.designer.actions.RotateAction.rotateTo(group, 90.0);
        action.redo();
