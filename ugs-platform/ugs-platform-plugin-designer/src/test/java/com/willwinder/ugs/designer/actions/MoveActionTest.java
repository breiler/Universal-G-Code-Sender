...
public class MoveActionTest {
    ...
    public void testMove() {
        ...
        com.willwinder.ugs.designer.actions.MoveAction moveAction = new com.willwinder.ugs.designer.actions.MoveAction(List.of(rectangle1, rectangle2), new Point2D.Double(10, 5));
        moveAction.redo();
