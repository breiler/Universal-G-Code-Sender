...
public class SurfaceToolPathTest {
    ...
    public void toGcodePathShouldGenerateGcodeFromStartDepth() {
        ...
        com.willwinder.ugs.designer.io.gcode.toolpaths.SurfaceToolPath toolPath = new com.willwinder.ugs.designer.io.gcode.toolpaths.SurfaceToolPath(settings, rectangle);
