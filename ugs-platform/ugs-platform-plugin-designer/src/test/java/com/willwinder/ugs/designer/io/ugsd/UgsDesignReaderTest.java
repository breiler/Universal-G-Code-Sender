...
public class UgsDesignReaderTest {
    ...
    public void readEmptyFileShouldReturnEmptyDesign() {
        com.willwinder.ugs.designer.io.ugsd.UgsDesignReader reader = new com.willwinder.ugs.designer.io.ugsd.UgsDesignReader();
    ...
    private String convertEntityToString(Entity entity) {
        ...
        com.willwinder.ugs.designer.io.ugsd.UgsDesignWriter writer = new com.willwinder.ugs.designer.io.ugsd.UgsDesignWriter();
