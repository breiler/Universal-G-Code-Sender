...
import com.willwinder.ugs.designer.io.gcode.toolpaths.GeometrySizeComparator;
...
public class GeometrySizeComparatorTest {
    ...
    public void compareShouldCompareIfShapeFitsInAnother() {
        ...
        Geometry geometry1 = com.willwinder.ugs.designer.io.gcode.toolpaths.ToolPathUtils.convertAreaToGeometry(new Area(rectangle1.getShape()), new GeometryFactory(), 1);

        Rectangle rectangle2 = new Rectangle();
        rectangle2.setPosition(new Point2D.Double(2.5,2.5));
        rectangle2.setSize(new Size(5, 5));
        Geometry geometry2 = com.willwinder.ugs.designer.io.gcode.toolpaths.ToolPathUtils.convertAreaToGeometry(new Area(rectangle2.getShape()), new GeometryFactory(), 1);
