...
public class GrblGcodeWriterTest {
    ...
    public void beginShouldWriteHeader() throws IOException {
        ...
        com.willwinder.ugs.designer.io.gcode.writer.GrblGcodeWriter writer = new com.willwinder.ugs.designer.io.gcode.writer.GrblGcodeWriter(new Settings(), result);
    ...
    public void pointCommandShouldUsePlungeSpeedAndWriteCoordinates() throws IOException {
        ...
        com.willwinder.ugs.designer.io.gcode.writer.GrblGcodeWriter writer = new com.willwinder.ugs.designer.io.gcode.writer.GrblGcodeWriter(settings, result);
