...
import static com.willwinder.ugs.designer.utils.PathUtils.getEndPoint;
import static com.willwinder.ugs.designer.utils.PathUtils.getSegments;
import static com.willwinder.ugs.designer.utils.PathUtils.getStartPoint;
import static com.willwinder.ugs.designer.utils.StitchPathUtils.stitchSegments;
...
public class StitchPathUtilsTest {
    ...
    public void stitchSegmentsWithLinesShouldIgnoreDuplicateSegments() {
        ...
        List<Segment> path = com.willwinder.ugs.designer.utils.PathUtils.getSegments(result.get(0));
    ...
    public void canonicalKey() {
        ...
        assertEquals(com.willwinder.ugs.designer.utils.StitchPathUtils.canonicalKey(line1), com.willwinder.ugs.designer.utils.StitchPathUtils.canonicalKey(line2));
    }
