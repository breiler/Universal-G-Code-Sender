...
public class PathUtilsTest {
    ...
    public void hasDrawableSegmentsWithOneMoveToIsNotDrawable() {
        ...
        path.moveTo(10, 10);
        assertFalse(com.willwinder.ugs.designer.utils.PathUtils.hasDrawableSegments(path));
    }
    ...
    public void joinPathsWithEmptyListShouldReturnEmptyPath() {
        ...
        assertTrue(com.willwinder.ugs.designer.utils.PathUtils.joinPaths(paths, com.willwinder.ugs.designer.utils.PathUtils.EPS).isEmpty());
    }
    ...
    public void joinPathsShouldJoinTwoLines() {
        ...
        Path2D result = com.willwinder.ugs.designer.utils.PathUtils.joinPaths(paths, com.willwinder.ugs.designer.utils.PathUtils.EPS).get();

        List<Segment> segments = com.willwinder.ugs.designer.utils.PathUtils.getSegments(result.getPathIterator(null));
