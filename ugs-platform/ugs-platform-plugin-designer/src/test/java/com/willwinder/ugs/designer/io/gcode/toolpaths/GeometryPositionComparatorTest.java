...
import com.willwinder.ugs.designer.io.gcode.toolpaths.GeometryPositionComparator;
...
public class GeometryPositionComparatorTest {
    ...
    private List<Geometry> generateEntities(int widthAndHeight) {
        ...
        while (count++ < 1000) {
            entities.add(com.willwinder.ugs.designer.io.gcode.toolpaths.ToolPathUtils.GEOMETRY_FACTORY.createPoint(new Coordinate(RandomUtils.nextDouble(0, widthAndHeight), RandomUtils.nextDouble(0, widthAndHeight), 0d)));
        }
        return entities;
    }
}
