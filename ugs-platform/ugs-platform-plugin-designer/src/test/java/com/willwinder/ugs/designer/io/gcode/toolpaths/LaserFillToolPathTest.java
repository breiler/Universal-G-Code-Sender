...
public class LaserFillToolPathTest {
    ...
    public void fillToolPathShouldNotConnectThePointEdgesWithALineSegment() {
        ...
        com.willwinder.ugs.designer.io.gcode.toolpaths.LaserFillToolPath toolPath = new com.willwinder.ugs.designer.io.gcode.toolpaths.LaserFillToolPath(settings, path);
