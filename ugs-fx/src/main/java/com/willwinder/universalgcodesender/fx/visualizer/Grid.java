...
public class Grid extends Group {
    ...
    private DoubleProperty minX = new SimpleDoubleProperty(0);
    private DoubleProperty minY = new SimpleDoubleProperty(0);
    private DoubleProperty maxX = new SimpleDoubleProperty(100);
    private DoubleProperty maxY = new SimpleDoubleProperty(100);
    double  gridSize = 10;
    public Grid() {
