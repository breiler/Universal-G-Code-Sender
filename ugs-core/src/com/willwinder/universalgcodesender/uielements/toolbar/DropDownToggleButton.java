...
import com.willwinder.universalgcodesender.utils.DisabledButtonFilter;
...
class DropDownToggleButton extends JToggleButton {
    ...
    public static ImageIcon createDisabledIcon(BufferedImage source) {
        ImageProducer producer = new FilteredImageSource(
                source.getSource(),
                DisabledButtonFilter.INSTANCE_LIGHT
        );
    ...
    public DropDownToggleButton(Icon icon, JPopupMenu popup) {
        ...
        setIcon(icon);
        setDisabledIcon(createDisabledIcon(toBufferedImage((ImageIcon) icon)));
