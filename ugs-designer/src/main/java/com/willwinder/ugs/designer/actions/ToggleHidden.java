...
public class ToggleHidden extends AbstractDesignAction implements SelectionListener {
    ...
    public void onSelectionEvent(SelectionEvent selectionEvent) {
        ...
        if (allIsHidden) {
            ...
            putValue(SMALL_ICON, SvgLoader.loadImageIcon(SMALL_ICON_HIDDEN_PATH, 16).orElse(null));
            putValue(LARGE_ICON_KEY, SvgLoader.loadImageIcon(LARGE_ICON_HIDDEN_PATH, 24).orElse(null));
