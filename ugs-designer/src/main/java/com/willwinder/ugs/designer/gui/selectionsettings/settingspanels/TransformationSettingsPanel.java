...
public class TransformationSettingsPanel extends JPanel implements EntitySettingsPanel {
    ...
    private void initializeComponents() {
        ...
        lockRatioButton = new JToggleButton(SvgLoader.loadImageIcon("img/link-off.svg", 16).orElse(null));
        lockRatioButton.setSelectedIcon(SvgLoader.loadImageIcon("img/link.svg", 16).orElse(null));
    }
