...
public class DropHandler implements DropTargetListener {
    ...
    private static boolean hasCorrectExtension(String filename) {
        return Arrays.stream(ToolImportAction.FILE_NAME_EXTENSION_FILTERS)
    ...
    public void drop(DropTargetDropEvent dtde) {
        ...
        ThreadHelper.invokeLater(() -> {
            ...
            ToolImportAction.readDesign(ControllerFactory.getController(), LookupService.lookup(BackendAPI.class).orElseThrow(), file);
