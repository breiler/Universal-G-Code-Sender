...
import com.willwinder.ugs.designer.actions.AlignBottomAction;
import com.willwinder.ugs.designer.actions.AlignCenterAction;
import com.willwinder.ugs.designer.actions.AlignLeftAction;
import com.willwinder.ugs.designer.actions.AlignMiddleAction;
import com.willwinder.ugs.designer.actions.AlignRightAction;
import com.willwinder.ugs.designer.actions.AlignTopAction;
...
import com.willwinder.ugs.designer.actions.JogMachineToNextAction;
import com.willwinder.ugs.designer.actions.JogMachineToPreviousAction;
...
import com.willwinder.ugs.designer.actions.MultiplyAction;
import com.willwinder.ugs.designer.actions.OffsetAction;
import com.willwinder.ugs.designer.actions.SnapToGridFiveAction;
import com.willwinder.ugs.designer.actions.SnapToGridHalfAction;
import com.willwinder.ugs.designer.actions.SnapToGridNoneAction;
import com.willwinder.ugs.designer.actions.SnapToGridOneAction;
import com.willwinder.ugs.designer.actions.SnapToGridTenAction;
import com.willwinder.ugs.designer.actions.SnapToGridTwoAction;
...
import com.willwinder.ugs.designer.actions.ToolVertextAction;
import com.willwinder.ugs.designer.actions.ToolZoomAction;
...
import com.willwinder.universalgcodesender.uielements.toolbar.DropDownButtonFactory;
import com.willwinder.universalgcodesender.uielements.toolbar.ToolbarWithOverflow;
 ...
 */
public class ToolBox extends ToolbarWithOverflow {
    ...
    private JToggleButton createAlignDropDownButton() {
        ...
        alignDropDownButton = DropDownButtonFactory.createDropDownToggleButton(SvgLoader.loadImageIcon(AlignCenterAction.LARGE_ICON_PATH, 24).orElse(null), popupMenu);
    ...
    private JToggleButton createJogDropDownButton() {
        ...
        jogDropDownButton = DropDownButtonFactory.createDropDownToggleButton(SvgLoader.loadImageIcon(JogMachineToCenterAction.LARGE_ICON_PATH, 24).orElse(null), popupMenu);
    ...
    private JToggleButton createToolDropDownButton() {
        ...
        toolDropDownButton = DropDownButtonFactory.createDropDownToggleButton(SvgLoader.loadImageIcon(ToolDrawRectangleAction.LARGE_ICON_PATH, 24).orElse(null), popupMenu);
    ...
    private JToggleButton createSnapDropdownButton() {
        ...
        snapDropDownButton = DropDownButtonFactory.createDropDownToggleButton(SvgLoader.loadImageIcon(SnapToGridOneAction.LARGE_ICON_PATH, 24).orElse(null), popupMenu);
