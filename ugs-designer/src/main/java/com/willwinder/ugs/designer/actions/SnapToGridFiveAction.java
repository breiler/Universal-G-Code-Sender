...
public class SnapToGridFiveAction extends AbstractDesignAction {
    ...
    public SnapToGridFiveAction() {
        ...
        putValue("menuText", "Snap to 5mm grid");
        putValue(NAME, "Snap to 5mm grid");
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        Controller controller = ControllerFactory.getController();
        controller.getDrawing().snapToGridUpdated(5.0);
    }
}
