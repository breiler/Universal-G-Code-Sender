 ...
 */
public class AlignMiddleAction extends AbstractDesignAction implements SelectionListener {
    public static final String SMALL_ICON_PATH = "img/alignmiddle.svg";
    public static final String LARGE_ICON_PATH = "img/alignmiddle24.svg";
    private final transient Controller controller;

    public AlignMiddleAction() {
        putValue("menuText", "Align middle");
        putValue(NAME, "Align middle");
        putValue("iconBase", SMALL_ICON_PATH);
        putValue(SHORT_DESCRIPTION, "Align the objects in middle of the first selected entity");
