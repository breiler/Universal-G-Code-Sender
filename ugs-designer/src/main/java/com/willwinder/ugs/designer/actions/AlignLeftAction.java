 ...
 */
public class AlignLeftAction extends AbstractDesignAction implements SelectionListener {
    public static final String SMALL_ICON_PATH = "img/alignleft.svg";
    public static final String LARGE_ICON_PATH = "img/alignleft24.svg";
    private final transient Controller controller;

    public AlignLeftAction() {
        putValue("menuText", "Align left");
        putValue(NAME, "Align left");
        putValue("iconBase", SMALL_ICON_PATH);
        putValue(SHORT_DESCRIPTION, "Align the objects to the left of the first selected entity");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Point2D destination = entity.getPosition(Anchor.LEFT_CENTER);
        ...
        for (int i = 1; i < selection.size(); i++) {
            Point2D position = selection.get(i).getPosition(Anchor.LEFT_CENTER);
