 ...
 */
public class ToolDrawLineAction extends AbstractDesignAction {
    public static final String SMALL_ICON_PATH = "img/line.svg";
    public static final String LARGE_ICON_PATH = "img/line24.svg";

    public ToolDrawLineAction() {
