...
import com.willwinder.ugs.designer.gui.selectionsettings.settingspanels.ComponentWithListener;
...
public class SelectionSettingsPanel extends JPanel implements SelectionListener, EntityListener, EntitySettingsModelListener {
    ...
    @Override
    public void onModelUpdate(com.willwinder.ugs.designer.entities.EntitySetting setting) {
