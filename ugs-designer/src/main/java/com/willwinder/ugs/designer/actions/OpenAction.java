...
public class OpenAction extends AbstractDesignAction {
    ...
    private static final String SMALL_ICON_PATH = "img/open.svg";
    private static final String LARGE_ICON_PATH = "img/open24.svg";
    ...
    public void actionPerformed(ActionEvent e) {
        com.willwinder.ugs.designer.actions.UndoManager undoManager = ControllerFactory.getUndoManager();
        undoManager.clear();
