...
public class EntityCellRenderer extends DefaultTreeCellRenderer {
    ...
    private static final Icon ICON_HIDDEN = SvgLoader.loadImageIcon("img/eyeoff24.svg", 24).orElse(null);
    private static final Icon ICON_GROUP_OPEN = SvgLoader.loadImageIcon("img/open24.svg", 24).orElse(null);
    private static final Icon ICON_GROUP_CLOSED = SvgLoader.loadImageIcon("img/folder24.svg", 24).orElse(null);
    ...
    public Component getTreeCellRendererComponent(JTree tree, Object value, boolean sel, boolean expanded, boolean leaf, int row, boolean hasFocus) {
        ...
        BackendAPI backendAPI = LookupService.lookup(BackendAPI.class).orElseThrow();
